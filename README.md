...
`spotify-overlay` is a low-resource, local Windows desktop utility that mirrors Spotify's current Windows media session into a transparent, customizable OBS Browser Source. It runs entirely on the streaming PC:
